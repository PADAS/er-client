...
def discovery_not_served():
    ...
    They all hand the client a token, and the first auth_headers() call now
    asks the site for its discovery document. A 404 is the answer that leaves
...
@pytest.fixture
def get_events_types_response_v1():
    return {
        "data": [
            {
...
@pytest.fixture
def get_events_types_response_v2():
    return {
        "data": [
            {
                "id": "5cef4738-11eb-449c-9a62-2aaaf730dbb3",
                "url": "https://sandbox.pamdas.org/api/v2.0/activity/eventtypes/gate_entry",
                "has_events_assigned": False,
                "icon_id": "generic_rep",
                "value": "gate_entry",
                "display": "Gate Entry 2.0",
                "ordernum": 0.0078125,
                "category": "tourism",
                "geometry_type": "Point",
                "default_priority": 100,
            ...
            {
                "id": "bbc2b8cb-00d5-4764-bd6f-afc1f721e7a7",
                "url": "https://sandbox.pamdas.org/api/v2.0/activity/eventtypes/affected_area",
                "has_events_assigned": False,
                "icon_id": "carcass_2_rep",
                "value": "affected_area",
...
@pytest.fixture
def events_types_response(request,
